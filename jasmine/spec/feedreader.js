...
$(function() {
    ...
    */
    ...
    /* test suite concerned with the menu visibility*/
    ...
    /* test suite concerned with loadFeed function and DOM manipulation  */
    ...
    /* test suite concerned with the feed changing with the source */
    describe('New Feed Section', function() {
        let InitialFeed, newFeed;

        /* load and save feed from different sources */
        beforeEach(function(done) {
            loadFeed(0, function() {
